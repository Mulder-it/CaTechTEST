...
import be.heh.catechtest.Thread.EnumRegulationDB;
import be.heh.catechtest.Thread.PlcHandler;
import be.heh.catechtest.Thread.PlcThreadRead;
import be.heh.catechtest.Thread.PlcThreadWrite;
