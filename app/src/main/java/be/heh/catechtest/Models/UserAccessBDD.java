...
public class UserAccessBDD {
    ...
    private static final String NOM_DB = "DatabaseProject";
    ...
    public UserAccessBDD(Context c){
        ...
        userdb = new Database(c, NOM_DB,null,VERSION);
    }
    ...
    public ArrayList<User> getAllUser() {
        ...
        Cursor c = db.query(TABLE_USER, new String[] {COL_ID, COL_NOM, COL_PRENOM,  COL_LOGIN, COL_PASSWORD, COL_ROLE }, null, null, null, null, COL_ID);
